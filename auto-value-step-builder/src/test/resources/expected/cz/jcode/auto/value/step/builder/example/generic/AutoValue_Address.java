...
public final class AutoValue_Address<T> extends $AutoValue_Address<T> {
    ...
    public interface BuildStep<T> extends java.util.function.Supplier<cz.jcode.auto.value.step.builder.example.generic.Address<T>>
    {
        cz.jcode.auto.value.step.builder.example.generic.Address<T> build();
    }
    ...
    public static class StepBuilder<T> implements TitleStep<T>, StreetStep<T>, CityStep<T>, PostcodeStep<T>, CountryCodeStep<T>, BuilderStep<T>, OptionalStep<T> {
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.generic.Address<T> build()
        {
            Address.Builder<T> builder = cz.jcode.auto.value.step.builder.example.generic.Address.<T>builder();
            builder.title(title);
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.generic.Address<T> get() {
            return build();
        }
    }
