...
public final class AutoValue_Address<T1> extends $AutoValue_Address<T1> {
    ...
    public interface BuildStep<T1> extends java.util.function.Supplier<cz.jcode.auto.value.step.builder.example.generic.Address<T1>>
    {
        cz.jcode.auto.value.step.builder.example.generic.Address<T1> build();
    }
    ...
    public static class StepBuilder<T1> implements TitleStep<T1>, StreetStep<T1>, CityStep<T1>, PostcodeStep<T1>, CountryCodeStep<T1>, BuilderStep<T1>, OptionalStep<T1> {
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.generic.Address<T1> build()
        {
            return cz.jcode.auto.value.step.builder.example.generic.Address.<T1>builder()
                .title(title)
                .street(street)
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.generic.Address<T1> get() {
            return build();
        }
    }
