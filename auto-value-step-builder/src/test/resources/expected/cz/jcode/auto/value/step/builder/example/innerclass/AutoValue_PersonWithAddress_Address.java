...
public final class AutoValue_PersonWithAddress_Address extends $AutoValue_PersonWithAddress_Address {
    ...
    public interface BuildStep extends java.util.function.Supplier<cz.jcode.auto.value.step.builder.example.innerclass.PersonWithAddress.Address>
    {
        cz.jcode.auto.value.step.builder.example.innerclass.PersonWithAddress.Address build();
    }
    ...
    public static class StepBuilder implements TitleStep, StreetStep, CityStep, PostcodeStep, CountryCodeStep, BuilderStep, OptionalStep {
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.innerclass.PersonWithAddress.Address build()
        {
            PersonWithAddress.Address.AddressBuilder builder = cz.jcode.auto.value.step.builder.example.innerclass.PersonWithAddress.Address.builder();
            builder.title(title);
        ...
        @Override
        public cz.jcode.auto.value.step.builder.example.innerclass.PersonWithAddress.Address get() {
            return build();
        }
    }
