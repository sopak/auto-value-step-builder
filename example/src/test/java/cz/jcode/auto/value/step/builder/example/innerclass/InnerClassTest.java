...
public class InnerClassTest {
    ...
    public static final PersonWithAddress.Address PERSON_WORK_ADDRESS = null;
    ...
    public void lazyStep() throws Exception {
        AutoValue_PersonWithAddress.OptionalLazyStep personBuilder = PersonWithAddress.lazyStep()
                .id(() -> PERSON_ID)
                .names(() -> ImmutableList.of(PERSON_NAME, PERSON_SURNAME))
                .phones(() -> ImmutableList.of(PERSON_PHONE))
                .homeAddress(
                        PersonWithAddress.Address.lazyStep()
                                .title(() -> ADDRESS_TITLE)
                                .street(() -> ADDRESS_STREET)
                                .city(() -> ADDRESS_CITY)
                                .postcode(() -> ADDRESS_POSTCODE)
        ...
        PersonWithAddress buildOne = personBuilder.build();
        assertPerson(buildOne);
        PersonWithAddress buildTwo = personBuilder.build();
    ...
    private void assertPerson(PersonWithAddress person) {

        PersonWithAddress copyOfPerson = person.toBuilder().build();
